...
<body>
  ...
  <header class="sticky-top">
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
      <div class="container">
        ...
        <button class="btn btn-outline-primary" type="button" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
          Daftar/Login
        </button>
  ...
  <main>
          ...
          <div class="modal-body">
            <form action="<?php echo e(Route('login')); ?>" method="POST">
              ...
              <div class="d-grid gap-1">
                ...
                <a href="<?php echo e(route('social.redirect', ['google'])); ?>" class="btn btn-success btn-google"><i class="bi bi-google"></i> Sign in with Google
                </a>
              </div>
            </form>
            <div class="text-center mt-3">
              <p class="small text-muted">Belum punya akun? <a href="#" id="signupLink" class="text-warning">Daftar</a>
              </p>
            </div>
          </div>
        </div>
            ...
            <form>
              ...
              <div class="mb-3 form-check">
                ...
                <label class="form-check-label" for="termCondition" style="font-size: 0.8rem;">
                  <small>
                    Dengan ini saya menyetujui <span class="text-primary">syarat dan ketentuan</span> yang berlaku
                    sesuai <span class="text-primary">Kebijakan Privasi</span> Homespot serta memberikan otorisasi
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="input-group py-5">
              ...
              <input type="text" class="form-control" placeholder="Cari lokasi, nama properti atau nama developer" />
    ...
    <section class="card-top">
      <div class="container min-vh-100 d-flex align-items-center justify-content-center carousel-homespot"></div>
    </section>
    <!-- Card Top End -->
      ...
      <div class="container carousel-homespot min-vh-100 d-flex align-items-center justify-content-center">
        <div class="row py-2 px-4">
          ...
          <div class="carousel slide" data-bs-ride="carousel" id="carouselHomespotBottom">
            <button id="carousel-control-prev-index-homespot-bottom" class="carousel-control-prev" type="button"
              data-bs-target="#carouselHomespotBottom" data-bs-slide="prev">
              <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            </button>
            <button id="carousel-control-next-index-homespot-bottom" class="carousel-control-next" type="button"
...
</html><?php /**PATH C:\MAXY ACADEMY\HACKATHON2\homespot-login\resources\views/user/homepage.blade.php ENDPATH**/ ?>