            ...
            <div class="modal-content">
                <div class="card mx-auto m-5" style="width: 30rem;">
                    ...
                    <div class="tutupbtn position-absolute top-0 end-0 m-2">
                        <a href="<?php echo e(route('homepage')); ?>" class="btn btn-close" aria-label="Close"></a>
                    </div>
...
<?php /**PATH C:\MAXY ACADEMY\HACKATHON2\homespot-login\resources\views/user/login.blade.php ENDPATH**/ ?>