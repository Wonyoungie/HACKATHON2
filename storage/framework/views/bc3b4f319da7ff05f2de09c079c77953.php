            ...
            <div class="col-3">
                <div class="card">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item list-group-item-homespot">
                            <div class="btnlogout">
                            <button class="btn btn-danger" onclick="window.location.href = '<?php echo e(route('homepage')); ?>';" type="button">
                                Logout
                            </button>
                            </div>
                        </li>
...
<?php /**PATH C:\MAXY ACADEMY\HACKATHON2\homespot-login\resources\views/user/userprofile.blade.php ENDPATH**/ ?>