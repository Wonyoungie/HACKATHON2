...
<html lang="en">
    ...
    <body>
        <div class="card col-md-4 mt-3 mx-auto">
            ...
            <form method="POST" action="<?php echo e(route('user_data.store')); ?>">
                <?php echo csrf_field(); ?>
                <div class="container">
                    <div class="row">
                        <div class=" mx-auto">
...
<?php /**PATH C:\MAXY ACADEMY\HACKATHON2\homespot-login\resources\views/user/profile.blade.php ENDPATH**/ ?>